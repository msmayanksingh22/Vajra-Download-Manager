    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            style={{ display: 'flex', alignItems: 'flex-start', gap: 'var(--sp-2)', minWidth: 0 }}
          >
            <span
              style={{
                flex: 1,
            ...
            <button
              ...
              onClick={() => copy(download.error || 'Unknown failure', 'error')}
              title="Copy Error"
            >
              {copiedField === 'error' ? (
      ...
      >
        <button className="btn-secondary" onClick={close} aria-label="Close window">
          Close
        </button>
        <button
