  ...
  return (
    <div className="dialog-overlay" onClick={() => onOpenChange(false)}>
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="spider-dialog-title"
      >
        {/* Header */}
        <div className="dialog-header">
          <div className="dialog-header-title flex items-center gap-2" id="spider-dialog-title">
            <Activity size={16} /> Site Spider
            <span
              style={{
                fontSize: '10px',
          ...
          <button className="btn-icon" onClick={() => onOpenChange(false)} title="Close">
            <X size={15} />
          </button>
        </div>
          ...
          <form onSubmit={handleStart} className="flex flex-col gap-2">
            <div className="flex gap-2">
              <input
                ...
                placeholder="Root URL to crawlâ€¦"
                value={url}
            ...
            <div className="flex gap-2">
              ...
              <input
                className="input-field flex-1"
                placeholder="Extensions e.g. pdf, mp4, zip"
                value={extStr}
            ...
            >
              {running ? (
                ...
                <span style={{ fontSize: 'var(--text-sm-size)' }}>
                  No results. Enter a URL and start the spider.
                </span>
              )}
            </div>
          ) : (
