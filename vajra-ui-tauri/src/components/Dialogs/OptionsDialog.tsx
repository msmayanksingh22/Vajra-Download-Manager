...
export default function OptionsDialog({ onClose }: { onClose: () => void }) {
  ...
  const [deletePreference, setDeletePreference] = useState(() =>
    localStorage.getItem('vajra_delete_preference'),
  );
  ...
  const Toggle = ({
    ...
    <label className="flex items-center justify-between" style={{ cursor: 'default' }}>
      {label && (
        <span
          style={{ fontSize: 'var(--text-sm-size)', fontWeight: 500, color: 'var(--color-text-1)' }}
        >
          {label}
        </span>
      )}
      ...
      >
        ...
        <div className="dialog-header" style={{ padding: '12px 20px' }}>
          <div className="dialog-header-title" style={{ gap: 10 }}>
            ...
            <div>
              ...
              >
                Configure Vajra's core behavior
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-1 overflow-hidden">
                  ...
                  <div>
                    <div
                      style={{
                        ...
                        color: isActive ? 'var(--color-brand)' : 'var(--color-text-1)',
                      }}
                    >
                      {t.id}
                    </div>
          ...
          <div
            ...
            style={{ padding: 'var(--sp-6)', backgroundColor: 'var(--color-surface)' }}
          >
            {!config ? (
              ...
              <div className="max-w-[500px] mx-auto animate-in slide-in-from-bottom-4 fade-in duration-300">
                  ...
                  <div className="flex flex-col gap-8">
                    <section>
                      <h3 className="text-sm font-bold text-1 mb-4 flex items-center gap-2">
                        <MonitorPlay size={16} style={{ color: 'var(--color-brand)' }} /> Appearance
                        & Theme
                      </h3>
                      <div className="bg-surface border border-muted rounded-2xl p-5 shadow-sm flex flex-col gap-6">
                        <div className="flex items-center justify-between">
                          <div className="pr-4">
                            ...
                            <div className="text-xs text-3 mt-1">
                              Select your preferred color scheme for Vajra.
                            </div>
                          </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="pr-4">
                            ...
                            <div className="text-xs text-3 mt-1">
                              Configure layout direction for RTL languages like Arabic and Hebrew.
                            </div>
                          </div>
                          <div className="flex items-center bg-surface-raised rounded-lg p-1">
                            {(
                    ...
                    <section>
                      <h3 className="text-sm font-bold text-1 mb-4 flex items-center gap-2">
                        <MonitorPlay size={16} style={{ color: 'var(--color-brand)' }} /> System
                        Integration
                      </h3>
                      <div className="bg-surface border border-muted rounded-2xl p-5 shadow-sm flex flex-col gap-6">
                        <div className="flex items-center justify-between">
                          <div className="pr-4">
                            ...
                            <div className="text-xs text-3 mt-1">
                              Automatically start Vajra in the background when Windows boots up.
                            </div>
                          </div>
                          <Toggle
                            active={config.auto_start_on_login}
                            onClick={() =>
                              updateConfig({ auto_start_on_login: !config.auto_start_on_login })
                            }
                          />
                        </div>
                        <div className="h-px bg-surface-raised w-full" />
                        <div className="flex items-center justify-between">
                          <div className="pr-4">
                            <div className="font-semibold text-sm text-1">
                              Browser Extension Integration
                            </div>
                            <div className="text-xs text-3 mt-1">
                              Captures downloads directly from Chrome, Edge, and Firefox.
                            </div>
                          </div>
                          <button
                        ...
                        <div className="flex items-center justify-between">
                          <div className="pr-4">
                            ...
                            <div className="text-xs text-3 mt-1">
                              Automatically detect and capture copied URLs.
                            </div>
                          </div>
                          <Toggle
                            active={config.enable_clipboard_monitor !== false}
                            onClick={() =>
                              updateConfig({
                                enable_clipboard_monitor:
                                  config.enable_clipboard_monitor === false ? true : false,
                              })
                            }
                          />
                        </div>
                    ...
                    <section>
                      <h3 className="text-sm font-bold text-1 mb-4 flex items-center gap-2">
                        <AlertCircle size={16} style={{ color: 'var(--color-brand)' }} />{' '}
                      ...
                      <div className="bg-surface border border-muted rounded-2xl p-5 shadow-sm flex flex-col gap-6">
                        <div className="flex items-center justify-between">
                          <div className="pr-4">
                            ...
                            <div className="text-xs text-3 mt-1">
                              Show a safety prompt when deleting files or clearing history.
                            </div>
                          </div>
                          <Toggle
                            active={!deletePreference}
                            onClick={() => {
                              if (deletePreference) {
                    ...
                    <section>
                      <h3 className="text-sm font-bold text-1 mb-4 flex items-center gap-2">
                        <Activity size={16} style={{ color: 'var(--color-brand)' }} /> Interception
                        Hotkeys
                      </h3>
                      <div className="bg-surface border border-muted rounded-2xl p-5 shadow-sm flex flex-col gap-4">
                        <div className="flex items-center justify-between bg-surface-raised p-3 rounded-xl border border-muted">
                          <span className="text-sm text-2">
                            Hold{' '}
                            <kbd className=" bg-surface-elevated border border-muted px-2 py-0.5 rounded shadow-sm font-bold text-1 mx-1">
                              Alt
                            </kbd>{' '}
                            during click
                          </span>
                          <span className="text-brand font-bold text-xs uppercase tracking-wide bg-brand-dim px-2 py-1 rounded-md">
                            Force Intercept
                          </span>
                        </div>
                        <div className="flex items-center justify-between bg-surface-raised p-3 rounded-xl border border-muted">
                          ...
                          <span className="text-warning font-bold text-xs uppercase tracking-wide bg-warning-dim px-2 py-1 rounded-md">
                            Bypass Vajra
                          </span>
                        </div>
                      </div>
                    ...
                    <section>
                      ...
                      <div className="bg-surface border border-muted rounded-2xl p-5 shadow-sm flex flex-col gap-6">
                        <div className="flex flex-col gap-2">
                          <label className="text-sm font-semibold text-1" id="label-extensions">
                            Auto-download Extensions
                          </label>
                          <p className="text-xs text-3" id="desc-extensions">
                            Automatically grab these file types from the browser.
                          </p>
                          <textarea
                            ...
                            value={
                              config.category_rules
                                ? config.category_rules
                                    .map((r: any) => r.extensions.join(' '))
                                    .join(' ')
                                : 'ZIP RAR EXE MP3 MP4 PDF MSI DMG'
                            }
                            onChange={(e) => {
                              ...
                              updateConfig({
                                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                                category_rules: config.category_rules?.map(
                                  (rule: any, idx: number) =>
                                    idx === 0 ? { ...rule, extensions: exts } : rule,
                                ),
                              });
                            }}
                          />
                        ...
                        <div className="flex flex-col gap-2">
                          <label className="text-sm font-semibold text-1" id="label-blacklist">
                            Domain Blacklist
                          </label>
                          <p className="text-xs text-3" id="desc-blacklist">
                            Never intercept downloads originating from these domains.
                          </p>
                          <textarea
                            ...
                            rows={3}
                            value={
                              config.blacklist_domains ? config.blacklist_domains.join(', ') : ''
                            }
                            onChange={(e) => {
                ...
                {activeTab === 'Connection' && (
                  <div className="flex flex-col gap-8">
                    <section>
                      <h3 className="text-sm font-bold text-1 mb-4 flex items-center gap-2">
                        <Server size={16} style={{ color: 'var(--color-brand)' }} /> Performance
                        Tuning
                      </h3>
                      <div className="bg-surface border border-muted rounded-2xl p-5 shadow-sm flex flex-col gap-6">
                        <div className="flex flex-col gap-2">
                          <label className="text-sm font-semibold text-1">
                            Default Max. Connections
                          </label>
                          <p className="text-xs text-3 mb-2">
                            Number of parallel segments to open per download by default.
                          </p>
                          <select
                            ...
                            onChange={(e) =>
                              updateConfig({
                                default_max_connections: parseInt(e.target.value, 10),
                              })
                            }
                          >
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <p className="text-xs text-3 mb-2">
                            Number of automatic download attempts on failure before displaying
                            failure window.
                          </p>
                          <select
                            className="select-field w-full"
                        ...
                        <div className="flex items-center justify-between">
                          <div className="pr-4">
                            <div className="font-semibold text-sm text-1">
                              HTTP/3 (QUIC) Prior Knowledge
                            </div>
                            <div className="text-xs text-3 mt-1">
                              Enable QUIC protocols by default for supported servers. Falling back
                              to HTTP/2 on fail.
                            </div>
                          </div>
                          <Toggle
                            active={config.default_use_http3 || false}
                            onClick={() =>
                              updateConfig({ default_use_http3: !config.default_use_http3 })
                            }
                          />
                        </div>
                      </div>
                ...
                {activeTab === 'Downloads' && (
                  <div className="flex flex-col gap-8">
                    <section>
                      <h3 className="text-sm font-bold text-1 mb-4 flex items-center gap-2">
                        <FolderOpen size={16} style={{ color: 'var(--color-brand)' }} /> Directory
                        Management
                      </h3>
                      <div className="bg-surface border border-muted rounded-2xl p-5 shadow-sm flex flex-col gap-6">
                        <div className="flex flex-col gap-2">
                    ...
                    <section>
                      <h3 className="text-sm font-bold text-1 mb-4 flex items-center gap-2">
                        <Activity size={16} style={{ color: 'var(--color-brand)' }} /> Advanced
                        Behaviors
                      </h3>
                      <div className="bg-surface border border-muted rounded-2xl p-5 shadow-sm flex flex-col gap-6">
                        <div className="flex flex-col gap-2">
                          <label className="text-sm font-semibold text-1">
                            Duplicate Filename Strategy
                          </label>
                          <select
                            className="select-field w-full"
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                          <Toggle
                            active={soundConfig.onComplete}
                            onClick={() =>
                              setSoundConfig((prev: any) => ({
                                ...prev,
                ...
                {activeTab === 'Categories' && (
                  <div className="flex flex-col gap-8">
                    <section>
                      <h3 className="text-sm font-bold text-1 mb-4 flex items-center gap-2">
                        <FolderOpen size={16} style={{ color: 'var(--color-brand)' }} /> Custom
                        Categories
                      </h3>
                      <div className="bg-surface border border-muted rounded-2xl p-5 shadow-sm flex flex-col gap-6">
                        <div className="text-sm text-3 mb-2">
                          Categories automatically route downloads to specific folders based on file
                          extensions. They also appear in the sidebar.
                        </div>

                        {config.category_rules?.map((rule: any, i: number) => (
                          <div
                            key={i}
                            className="flex flex-col gap-3 p-4 rounded-xl border border-muted bg-surface-raised relative"
                          >
                            <button
                            ...
                            <div className="flex gap-4 items-center">
                              <label className="text-xs font-semibold text-2 w-20">
                                Extensions
                              </label>
                              <input
                                className="flex-1 bg-surface-elevated border border-muted rounded-md px-2 py-1 text-sm text-1 focus:border-brand outline-none"
                ...
                {activeTab === 'Automation & Security' && (
                  <div className="flex flex-col gap-8">
                    <section>
                      <h3 className="text-sm font-bold text-1 mb-4 flex items-center gap-2">
                        <Activity size={16} style={{ color: 'var(--color-brand)' }} /> Global
                        Scheduler
                      </h3>
                      <div className="bg-surface border border-muted rounded-2xl p-5 shadow-sm flex flex-col gap-6">
                        <div className="flex items-center justify-between">
                          <div className="pr-4">
                            ...
                            <div className="text-xs text-3 mt-1">
                              Automatically pause and resume the download queue based on time of
                              day.
                            </div>
                          </div>
                          <Toggle
                            active={config.scheduler_enabled || false}
                            onClick={() =>
                              updateConfig({ scheduler_enabled: !config.scheduler_enabled })
                            }
                          />
                        </div>
                        ...
                        <div
                          className={cn(
                            'transition-all duration-300 overflow-hidden flex gap-4',
                            config.scheduler_enabled
                              ? 'opacity-100 max-h-[100px]'
                              : 'opacity-50 pointer-events-none max-h-[100px]',
                          )}
                        >
                          <div className="flex-1 flex flex-col gap-2">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                updateConfig({ scheduler_start_time: e.target.value })
                              }
                            />
                          </div>
                          <div className="flex-1 flex flex-col gap-2">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                updateConfig({ scheduler_stop_time: e.target.value })
                              }
                            />
                          </div>
                        </div>
                    ...
                    <section>
                      <h3 className="text-sm font-bold text-1 mb-4 flex items-center gap-2">
                        <FileCheck2 size={16} style={{ color: 'var(--color-brand)' }} /> Security
                        Integrations
                      </h3>
                      <div className="bg-surface border border-muted rounded-2xl p-5 shadow-sm flex flex-col gap-6">
                        <div className="flex flex-col gap-2">
                          <div className="flex items-center justify-between mb-2">
                            ...
                            {config.auto_extract && (
                              <span className="text-xs font-bold uppercase tracking-wider tag-brand rounded-full">
                                Active
                              </span>
                            )}
                          </div>
                          <div className="flex items-center justify-between">
                            <div className="text-xs text-3 pr-4">
                              Automatically extract .zip and .7z archives upon successful download.
                            </div>
                            <Toggle
                              active={config.auto_extract || false}
                              onClick={() => updateConfig({ auto_extract: !config.auto_extract })}
                            />
                          </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <div className="flex gap-2">
                            <input
                              ...
                              onChange={(e) =>
                                updateConfig({ post_process_script: e.target.value || null })
                              }
                            />
                            <button
                              className="btn-secondary px-4 rounded-lg text-sm font-semibold"
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <div className="flex gap-2">
                            <input
                              ...
                              onChange={(e) =>
                                updateConfig({ av_scan_path: e.target.value || null })
                              }
                            />
                            <button
                              className="btn-secondary px-4 rounded-lg text-sm font-semibold"
                          ...
                          <div className="mt-2">
                            <label className="text-xs font-semibold text-2 uppercase tracking-wider mb-1 block">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                updateConfig({ av_scan_args: e.target.value || null })
                              }
                            />
                            <p className="text-xs text-3 mt-1">
                              Use <code style={{ color: 'var(--color-brand)' }}>{'{FILE}'}</code> to
                              represent the downloaded file path.
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <section>
                      ...
                      <div className="bg-surface border border-muted rounded-2xl p-5 shadow-sm flex flex-col gap-6">
                        <div className="flex flex-col gap-2">
                          ...
                          <p className="text-xs text-3 mt-1">
                            The API key is encrypted using XChaCha20-Poly1305 and stored locally in
                            the secure database vault. It will be used automatically when downloads
                            encounter a captcha block.
                          </p>
                        </div>
                      </div>
                    </section>
                ...
                {activeTab === 'Proxy / Socks' && (
                  <div className="flex flex-col gap-8">
                    <section>
                      <h3 className="text-sm font-bold text-1 mb-4 flex items-center gap-2">
                        <Network size={16} style={{ color: 'var(--color-brand)' }} /> Network
                        Routing
                      </h3>
                      ...
                      <div className="bg-surface border border-muted rounded-2xl shadow-sm flex flex-col overflow-hidden">
                        <label
                          className={cn(
                            'flex items-center gap-4 p-5 cursor-pointer transition-colors border-b border-subtle',
                            !config.proxy?.use_system_proxy && !config.proxy?.url
                              ? 'bg-brand-dim'
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div className="text-xs text-3 mt-0.5">
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div className="text-xs text-3 mt-0.5">
                              Use Windows Internet Options proxy
                            </div>
                          </div>
                        </label>
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div className="text-xs text-3 mt-0.5">
                              Specify HTTP / SOCKS proxy details
                            </div>
                          </div>
                        </label>
                      </div>
                    ...
                    <section className="mt-6">
                      <h3 className="text-sm font-bold text-1 mb-4 flex items-center gap-2">
                        <AlertCircle size={16} style={{ color: 'var(--color-brand)' }} /> Tor
                        Network Integration
                      </h3>
                      <div className="bg-surface border border-muted rounded-2xl p-5 shadow-sm flex flex-col gap-4">
                        <div className="flex items-center justify-between">
                          <div>
                            <div className="font-semibold text-sm text-1">
                              Tor Network Routing (SOCKS5h)
                            </div>
                            <div className="text-xs text-3 mt-1">
                              Route all download traffic through a local Tor proxy (127.0.0.1:9050)
                              with remote DNS.
                            </div>
                          </div>
                          <Toggle
                            ...
                            onClick={() =>
                              updateProxy({ route_via_tor: !config.proxy?.route_via_tor })
                            }
                          />
                        </div>
                      </div>
                      ...
                      <div className="bg-surface border border-muted rounded-2xl p-5 shadow-sm flex flex-col gap-4">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <div className="text-xs text-3 mt-1">
                              Resolve hostname queries securely over HTTPS via Cloudflare DNS.
                            </div>
                          </div>
                          <Toggle
                            active={config.dns_over_https}
                            onClick={() => updateConfig({ dns_over_https: !config.dns_over_https })}
                          />
                        </div>
                      </div>
                    </section>
                ...
                {activeTab === 'Site Logins' && (
                  <div className="flex flex-col gap-8">
                    <section>
                      <h3 className="text-sm font-bold text-1 mb-4 flex items-center gap-2">
                        <Fingerprint size={16} style={{ color: 'var(--color-brand)' }} /> Site
                        Credentials
                      </h3>
                      ...
                      <div className="bg-surface border border-muted rounded-2xl shadow-sm overflow-hidden flex flex-col h-[380px]">
                        <div className="bg-surface-raised p-4 border-b border-muted flex flex-col gap-3">
                          <p className="text-xs text-3">
                            These credentials will automatically be injected into HTTP Basic Auth
                            requests for matching domains.
                          </p>
                          <div className="flex gap-2 items-center">
                            <input
                              ...
                              value={newLoginHost}
                              onChange={(e) => setNewLoginHost(e.target.value)}
                            />
                            <input
                              type="text"
                          ...
                          {logins.length === 0 ? (
                            ...
                            <div className="divide-y divide-muted">
                              {logins.map((item) => (
                                <div
                                  key={item.id}
                                  className="flex justify-between items-center px-5 py-3 hover:bg-surface-raised transition-colors group"
                                >
                                  <div className="flex flex-col">
                                    <span className="font-semibold text-sm text-1">
                                      {item.domain}
                                    </span>
                                    <span className="text-xs text-3 mt-0.5">
                                      User: {item.username}
                                    </span>
                                  </div>
                                  <button
                      ...
                      <div className="bg-surface border border-muted rounded-2xl p-5 shadow-sm flex flex-col gap-4">
                        ...
                        <div className="flex gap-4">
                          <ConfigInput
                            ...
                            // eslint-disable-next-line @typescript-eslint/no-explicit-any
                            onChange={(e: any) =>
                              setDialup((prev: any) => ({ ...prev, username: e.target.value }))
                            }
                          />
                          <ConfigInput
                            label="Password"
                            ...
                            // eslint-disable-next-line @typescript-eslint/no-explicit-any
                            onChange={(e: any) =>
                              setDialup((prev: any) => ({ ...prev, password: e.target.value }))
                            }
                          />
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="pr-4">
                            ...
                            <div className="text-xs text-3 mt-1">
                              Number of times to attempt reconnecting if connection is lost.
                            </div>
                          </div>
                          <input
                            type="number"
                            ...
                            onChange={(e) =>
                              setDialup((prev: any) => ({
                                ...prev,
                                redialCount: parseInt(e.target.value, 10) || 0,
                              }))
                            }
                          />
                        </div>
